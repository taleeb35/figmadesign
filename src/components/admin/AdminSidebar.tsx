import { FileText, Settings, FolderKanban, BarChart3, Image, HelpCircle, Home, Info, Mail, MessageSquare } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Inquiries", url: "/admin/dashboard/inquiries", icon: MessageSquare },
