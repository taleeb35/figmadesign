        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-10">
          ...
          <div>
            <ul className="space-y-4 text-base">
              ...
              <li><a href="/statistics" className="font-bold text-gray-900 hover:text-[hsl(var(--accent))]">Static’s</a></li>
          ...
          <div>
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3 align-items-center">
                <div className="w-10 h-10 rounded-full bg-[hsl(var(--accent))] flex items-center justify-center flex-shrink-0"><svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"></path></svg></div>
